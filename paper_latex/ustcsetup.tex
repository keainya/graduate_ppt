...
\ustcsetup{
  title                = {面向AI多任务场景的资源调度系统\\设计与实现},
  title*               = {Design and Implementation of Resource Scheduling System for AI Multi-task Scenarios},
  author               = {谢博谦},
  author*              = {Xie Boqian},
  speciality           = {软件工程},
  speciality*          = {Software Engineering},
  supervisor           = {赵功名\ 副教授},
  supervisor*          = {Assoc. Prof. Zhao Gongming},
  practice-supervisor  = {张钟\ 高级工程师},  % 专业/工程学位的实践导师
  practice-supervisor* = {Eng. Zhang Zhong},
